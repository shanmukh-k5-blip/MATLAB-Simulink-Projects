% Adams / MATLAB Interface - Release 2024.2.0
...
elseif strcmp(machine, 'PCWIN64')
   ...
   [flag, topdir]=system('adams2024_2 -top');
if flag == 0
  ...
  addpath( 'D:\MSCADA~1\controls/win64' ) ;
  addpath( 'D:\MSCADA~1\controls/matlab' ) ;
  addpath( 'D:\MSCADA~1\controls/utils' ) ;
  ADAMS_sysdir = 'D:\MSCADA~1\' ;
end
ADAMS_exec = '' ;
ADAMS_host = 'My-Machine' ;
ADAMS_cwd ='D:\MSC ADAMS\AdamsTutorialKit\Adams Tutorial Kit_3rd Edition\Example 36_Bridge Crane\completed' ;
ADAMS_prefix = 'Bridge_Crane_plant' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
ADAMS_version = '2024_2' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'Input_Vel' ;
ADAMS_outputs = 'Sway_Angle' ;
